...
export const ProductCollection = () => {
  ...
  return (
    <section id="collection" className="bg-[--background] py-14 px-4 text-white">
      <div className="max-w-7xl mx-auto">
        ...
        {/*  MAIN TITLE */}
        <div className="text-center mb-16 text-text">
          <h1 className="text-5xl  font-[1000] tracking-tighter" >OUR COLLECTION</h1>
          <p className="text-gray-400 mt-2">Premium Fashion</p>
        </div>

        {/* ================= MEN ================= */}
        <h2 className="text-3xl font-bold mb-6 text-text">MEN COLLECTION</h2>
        ...
        {/* ================= WOMEN ================= */}
        <h2 className="text-3xl font-bold mt-16 mb-6 text-text">WOMEN COLLECTION</h2>
        ...
        <div className="mt-16">
          ...
          <div className="flex justify-center gap-3 mt-10">
            ...
            aria-label="previous"
              ...
              className="px-4 py-2 rounded-full border text-text border-zinc-700 "
            >
              Prev
            </button>
            ...
            {[...Array(totalPages)].map((_, i) => (
              ...
              aria-label="added no."
                ...
                className={`px-4 py-2 rounded-full ${
                  page === i + 1 ? "bg-orange-500" : "border text-text border-zinc-700"
                }`}
              >
                {i + 1}
              </button>
            ...
            aria-label="next"
              ...
              onClick={() => setPage(page + 1)}
              className="px-4 py-2 rounded-full text-text border  border-zinc-700"
            >
              Next
            </button>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-20 text-center text-sm text-foreground">
