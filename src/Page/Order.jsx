...
const MOCK_ORDERS = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        price: 599,
        image:
          "https://images.unsplash.com/photo-1474979266404-7eaacbcd87c5?w=120&q=80",
      },
      {
        ...
        price: 249,
        image:
          "https://images.unsplash.com/photo-1615485500704-8e990f9900f7?w=120&q=80",
      },
    ],
  },
  {
    ...
    items: [
      {
        name: "Khakhra – Methi Masala",
        qty: 4,
        price: 199,
        image:
          "https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=120&q=80",
      },
      {
        name: "Jaggery Block – Sugarcane",
        qty: 2,
        price: 299,
        image:
          "https://images.unsplash.com/photo-1596040033229-a9821ebd058d?w=120&q=80",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        price: 699,
        image:
          "https://images.unsplash.com/photo-1586201375761-83865001e31c?w=120&q=80",
      },
      {
        name: "Cardamom Pods",
        qty: 2,
        price: 110,
        image:
          "https://images.unsplash.com/photo-1638179440888-1e553d8c7879?w=120&q=80",
      },
    ],
  },
];
        ...
        {s.track.map((label, i) => {
          ...
          return (
            ...
            >
              ...
              <span
                className={`text-[9px] font-medium text-center leading-tight max-w-[44px]
    ...
    <div className="relative">
      ...
      <div className="flex justify-between items-start">
        <div>
          ...
          <p className="mt-0.5 text-base font-bold text-zinc-800 font-mono">
            {order.id}
          </p>
        </div>
      ...
      <div className="p-6">
        ...
        <div className="flex justify-between items-start">
          <div>
            ...
            <h2 className="text-xl font-black text-zinc-900 font-mono mt-0.5">
              {order.id}
            </h2>
          </div>
...
const OrdersPage = () => {
  const [orders] = useState(() => {
    try {
      ...
      return stored?.length ? stored : MOCK_ORDERS;
    } catch {
      return MOCK_ORDERS;
    }
  });
          ...
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-amber-400 to-orange-500 flex items-center justify-center shadow-md shadow-orange-200">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
                <path
                  d="M3 9h18M9 9V4m6 5V4M5 20h14a2 2 0 002-2V9a2 2 0 00-2-2H5a2 2 0 00-2 2v9a2 2 0 002 2z"
                  stroke="white"
                  strokeWidth="2.2"
                  strokeLinecap="round"
                />
