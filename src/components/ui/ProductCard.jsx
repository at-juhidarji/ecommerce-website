      ...
      <Card className="relative border-none shadow-none bg-zinc-900 overflow-hidden rounded-[20px] aspect-[1/1.2]">
        <CardContent className="p-0 h-full">
          ...
          <div className="absolute inset-0 bg-black/50 flex flex-col items-center justify-center gap-3 opacity-0 group-hover:opacity-100 transition">
            <Button className="bg-white font-[1000] tracking-tighter uppercase  text-black rounded-full px-4 py-2 font-bold">
              Add to Cart
            </Button>

            <Button className="bg-black font-[1000] tracking-tighter uppercase  text-white border border-white rounded-full px-4 py-2">
              Buy Now
            </Button>
          </div>
        </CardContent>
